...
class HuffmannNode:
  def __init__(self,node=None):
    self.right = None
    self.left = None
    self.freq = node[0] if node else None
    self.char = node[1] if node else None
